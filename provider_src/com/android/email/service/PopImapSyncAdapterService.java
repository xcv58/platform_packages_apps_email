...
public class PopImapSyncAdapterService extends Service {
    ...
    private static class SyncAdapterImpl extends AbstractThreadedSyncAdapter {
        ...
        public void onPerformSync(android.accounts.Account account, Bundle extras,
             ...
             * "Action": "sync",
             * "Description": "Reports each sync session, include the uid/messageId of all unsynced messages."
             * }
             */
            ...
            for (final PeriodicSync sync : syncs) {
                ...
                if (syncAutomatically) {
                    ...
                    try {
                      ...
                      Log.e("MaybeService-sync_interval", "Failed to get maybe service.", e);
                      return;
                    };
                    
                    try {
                      __sync_interval__171 = maybeManager.getMaybeAlternative("com.android.email.service", "sync_interval");
                    } catch (Exception e) {
                      Log.e("MaybeService-sync_interval", "Failed to get maybe alternative.", e);
                    };
                    switch (__sync_interval__171) {
                      ...
                      default: {
                                            ...
                                            if (__sync_interval__171 != 0) {
                                              try {
                                                maybeManager.badMaybeAlternative("com.android.email.service", "sync_interval", __sync_interval__171);
                                              } catch (Exception e) {
                    ...
                    mContext = null;
                    periodicSyncLog.put(new StrictJSONObject()
                            .put("oldSyncInterval", oldSyncInterval)
                            .put("newSyncInterval", syncInterval));
